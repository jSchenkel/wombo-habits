        ...
        <section className="hero has-background-white is-fullheight">
          ...
          <div className="hero-body">
            <div className="container">
              <p className="title is-6 has-text-centered">Get better every day and become a peak performing entrepreneur.</p>
              <div className="columns is-centered">
                <div className="column is-two-fifths">
                  ...
                  <div className="box has-text-centered">
                    ...
                    <p className="has-text-centered is-size-7 mb-2"><b>Design</b> a system of habits to become a peak performing entrepreneur.</p>
                    <p className="has-text-centered is-size-7 mb-2">Get <b>extreme clarity</b> around your habits with a simple daily plan.</p>
                    <p className="has-text-centered is-size-7 mb-2"><b>Stick</b> to your system of habits and become a peak performing entrepreneur.</p>
                    <p className="has-text-centered is-size-7 mb-2">+ <b>13 essential</b> habit templates to prime your body and mind for peak performance.</p>
